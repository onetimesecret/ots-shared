...
def generate_envrc_template(
    ...
    lines = [
        ...
        "",
        "# Path to SSH private key for deploy user",
...
def generate_ssh_config(
    ...
    Args:
        ...
        ssh_keyfile: Path to SSH private key. Defaults to placeholder.
    ...
    keyfile = ssh_keyfile or "<DEPLOY_SSH_KEYFILE>"
    ordinal = "01"
...
def create_ssh_config(
    ...
    *,
    ...
    Args:
        ...
        ssh_keyfile: Path to SSH private key for IdentityFile.
    ...
    # Generate config with directory path substituted for known_hosts
    content = generate_ssh_config(marker, env_name, ssh_keyfile)
